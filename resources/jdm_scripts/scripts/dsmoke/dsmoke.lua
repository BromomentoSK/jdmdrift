...
RegisterCommand('tiresmoke', function()
    ...
    if _SMOKE_ON then exports['mythic_notify']:SendAlert('success', 'Tire Smoke Enabled') else exports['mythic_notify']:SendAlert('error', 'Tire Smoke Disabled') end
end)
